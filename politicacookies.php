<?php include "header.php" ?>
	...
	<div class="row">
		<div class="col-sm-12"><h2>POLITICA DE COOKIES</h2>
...
<p>Sin su expreso consentimiento –mediante la activación de las cookies en su navegador– Incredible Green Box no enlazará en las cookies los datos memorizados con sus datos personales proporcionados en el momento del registro o la compra..</p>
...
<p>Si tiene dudas sobre esta política de cookies, puede contactar con nosotros en info@incrediblegreenbox(punto)com</p></div>
	</div>
